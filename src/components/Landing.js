    ...
    <div className="container py-4">
      ...
      <div className="p-5 mb-4 border rounded-3" style={{ backgroundColor: "#E4E4E4", color: "#34415E" }}>
        <div className="container-fluid py-5" >
          ...
          <p className="col-md-8 fs-4">Finding content online can be challenging, you google your way through countless number of posts and articles. Use conten.in and follow people with similar interests, share content links and show the world what you like. Contact us at <small><b>conten.help@gmail.com</b></small></p>
